    ...
    <div>
        <section class="py-5">
            <div class="container-fluid my-lg-5 pt-lg-4" v-if="isLoaded">
                ...
                <button @click="share" class="btn btn-light" type="button" v-if="canShare">
                    Share
                    ...
                    <div class="card-body p-lg-5">
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <h6>No. Anggota</h6>
                                <p class="p-0">{{anggota.card_number}}</p>
                            </div>
                            <div class="col-12 col-md-4">
                                <h6>Jurusan</h6>
                                <p class="m-0">{{anggota.major.name}}</p>
                            </div>
                            <div class="col-12 col-md-4">
                                <h6>Tahun Angkatan</h6>
                                <p class="m-0">{{anggota.year}}</p>
                            </div>
                            <div class="col-12 col-md-4">
                                <h6>Asal Sekolah</h6>
                                <p class="m-0">{{anggota.school.name}}</p>
                            </div>
                            <div class="col-12 col-md-4">
                                <h6>Asal Tempat Tinggal</h6>
                                <p class="m-0">{{anggota.address_now}}</p>
                            </div>
                            <div class="col-12 col-md-4">
                                <h6>Tempat Tinggal</h6>
                                <p class="m-0">{{anggota.address_from}}</p>
                            </div>
                        </div>
                    </div>
                </div>
